...
| 21 | 3. Browser acceptance run, release gate, docs | in progress | **Scenario passed** on `d99bd7b` — see the run record. First `release_gate` returned NEEDS WORK on one blocking defect, now fixed; re-gate in progress. |
